...
architecture behav of msm_arr is 
    ...
    "msm_arr_msm_arr,hls_ip_2020_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcvu9p-flga2104-2-i,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=3.126812,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=4,HLS_SYN_DSP=0,HLS_SYN_FF=3417,HLS_SYN_LUT=6795,HLS_VERSION=2020_2}";
    ...
    signal i_reg_385 : STD_LOGIC_VECTOR (7 downto 0);
    signal i_1_reg_396 : STD_LOGIC_VECTOR (7 downto 0);
    signal i_2_reg_407 : STD_LOGIC_VECTOR (4 downto 0);
    signal num_padd_ops_V_reg_418 : STD_LOGIC_VECTOR (12 downto 0);
    signal add_ln98_fu_440_p2 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal icmp_ln98_fu_446_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln98_reg_632 : STD_LOGIC_VECTOR (0 downto 0);
    signal zext_ln98_fu_452_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln98_reg_636 : STD_LOGIC_VECTOR (63 downto 0);
    signal add_ln108_fu_498_p2 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal icmp_ln108_reg_667 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln108_reg_667_pp1_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_state14_pp1_stage0_iter2 : BOOLEAN;
    signal ap_enable_reg_pp1_iter2 : STD_LOGIC := '0';
    signal ap_block_pp1_stage0_11001 : BOOLEAN;
    signal icmp_ln108_fu_504_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal zext_ln108_fu_510_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln108_reg_671 : STD_LOGIC_VECTOR (63 downto 0);
    signal GBUFF_K_V_q0 : STD_LOGIC_VECTOR (3 downto 0);
    signal p_Val2_s_reg_681 : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_enable_reg_pp1_iter1 : STD_LOGIC := '0';
    signal count_B_V_addr_16_reg_686 : STD_LOGIC_VECTOR (3 downto 0);
    signal addr_cmp_fu_523_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal addr_cmp_reg_692 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln117_fu_564_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln117_reg_702 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal add_ln117_fu_570_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal ap_enable_reg_pp2_iter0 : STD_LOGIC := '0';
    signal num_padd_ops_V_2_fu_599_p3 : STD_LOGIC_VECTOR (12 downto 0);
    ...
    signal zext_ln534_fu_515_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln117_fu_576_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal reuse_addr_reg_fu_110 : STD_LOGIC_VECTOR (63 downto 0);
    signal reuse_reg_fu_114 : STD_LOGIC_VECTOR (12 downto 0);
    signal add_ln691_fu_544_p2 : STD_LOGIC_VECTOR (12 downto 0);
    signal ap_block_pp1_stage0_01001 : BOOLEAN;
    signal v1_V_fu_468_p1 : STD_LOGIC_VECTOR (12 downto 0);
    signal v2_V_2_fu_464_p1 : STD_LOGIC_VECTOR (12 downto 0);
    signal v2_V_fu_460_p1 : STD_LOGIC_VECTOR (12 downto 0);
    signal reuse_select_fu_537_p3 : STD_LOGIC_VECTOR (12 downto 0);
    signal add_ln691_1_fu_587_p2 : STD_LOGIC_VECTOR (12 downto 0);
    signal icmp_ln874_fu_581_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal num_padd_ops_V_1_fu_593_p2 : STD_LOGIC_VECTOR (12 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state11)) then 
                i_1_reg_396 <= ap_const_lv8_0;
            elsif (((ap_const_boolean_0 = ap_block_pp1_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0) and (icmp_ln108_fu_504_p2 = ap_const_lv1_0) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state15)) then 
                i_2_reg_407 <= ap_const_lv5_1;
            elsif (((ap_const_boolean_0 = ap_block_pp2_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp2_stage0) and (ap_enable_reg_pp2_iter0 = ap_const_logic_1) and (icmp_ln117_fu_564_p2 = ap_const_lv1_0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state8)) then 
                i_reg_385 <= ap_const_lv8_0;
            elsif (((icmp_ln98_fu_446_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
                i_reg_385 <= add_ln98_fu_440_p2;
            end if; 
        end if;
    end process;

    num_padd_ops_V_reg_418_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state15)) then 
                num_padd_ops_V_reg_418 <= ap_const_lv13_0;
            elsif (((ap_const_boolean_0 = ap_block_pp2_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp2_stage0) and (ap_enable_reg_pp2_iter1 = ap_const_logic_1) and (icmp_ln117_reg_702 = ap_const_lv1_0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((ap_const_boolean_0 = ap_block_pp1_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0) and (ap_enable_reg_pp1_iter1 = ap_const_logic_1) and (icmp_ln108_reg_667 = ap_const_lv1_0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state11)) then 
                reuse_reg_fu_114 <= ap_const_lv13_0;
            elsif (((ap_const_boolean_0 = ap_block_pp1_stage0_11001) and (ap_enable_reg_pp1_iter2 = ap_const_logic_1) and (icmp_ln108_reg_667_pp1_iter1_reg = ap_const_lv1_0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp1_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0) and (icmp_ln108_reg_667 = ap_const_lv1_0))) then
                addr_cmp_reg_692 <= addr_cmp_fu_523_p2;
                count_B_V_addr_16_reg_686 <= zext_ln534_fu_515_p1(4 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp1_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0) and (ap_enable_reg_pp1_iter1 = ap_const_logic_1) and (icmp_ln108_reg_667 = ap_const_lv1_0))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp1_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0) and (icmp_ln108_fu_504_p2 = ap_const_lv1_0))) then
                    zext_ln108_reg_671(7 downto 0) <= zext_ln108_fu_510_p1(7 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln98_fu_446_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                    zext_ln98_reg_636(7 downto 0) <= zext_ln98_fu_452_p1(7 downto 0);
            end if;
        end if;
    end process;
    zext_ln98_reg_636(63 downto 8) <= "00000000000000000000000000000000000000000000000000000000";
    zext_ln108_reg_671(63 downto 8) <= "00000000000000000000000000000000000000000000000000000000";

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_enable_reg_pp0_iter0, icmp_ln98_fu_446_p2, ap_enable_reg_pp1_iter0, ap_enable_reg_pp1_iter2, icmp_ln108_fu_504_p2, ap_enable_reg_pp1_iter1, icmp_ln117_fu_564_p2, ap_enable_reg_pp2_iter0, ap_block_pp0_stage0_subdone, ap_block_pp1_stage0_subdone, ap_block_pp2_stage0_subdone, ap_CS_fsm_state19, ap_block_state19_on_subcall_done)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_pp0_stage0 => 
                if (not(((icmp_ln98_fu_446_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1)))) then
                    ap_NS_fsm <= ap_ST_fsm_pp0_stage0;
                elsif (((icmp_ln98_fu_446_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then
            ...
            when ap_ST_fsm_pp1_stage0 => 
                if ((not(((ap_const_boolean_0 = ap_block_pp1_stage0_subdone) and (ap_enable_reg_pp1_iter1 = ap_const_logic_0) and (icmp_ln108_fu_504_p2 = ap_const_lv1_1) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1))) and not(((ap_const_boolean_0 = ap_block_pp1_stage0_subdone) and (ap_enable_reg_pp1_iter1 = ap_const_logic_0) and (ap_enable_reg_pp1_iter2 = ap_const_logic_1))))) then
                    ap_NS_fsm <= ap_ST_fsm_pp1_stage0;
                elsif ((((ap_const_boolean_0 = ap_block_pp1_stage0_subdone) and (ap_enable_reg_pp1_iter1 = ap_const_logic_0) and (icmp_ln108_fu_504_p2 = ap_const_lv1_1) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1)) or ((ap_const_boolean_0 = ap_block_pp1_stage0_subdone) and (ap_enable_reg_pp1_iter1 = ap_const_logic_0) and (ap_enable_reg_pp1_iter2 = ap_const_logic_1)))) then
            ...
            when ap_ST_fsm_pp2_stage0 => 
                if (not(((ap_const_boolean_0 = ap_block_pp2_stage0_subdone) and (ap_enable_reg_pp2_iter0 = ap_const_logic_1) and (icmp_ln117_fu_564_p2 = ap_const_lv1_1)))) then
                    ap_NS_fsm <= ap_ST_fsm_pp2_stage0;
                elsif (((ap_const_boolean_0 = ap_block_pp2_stage0_subdone) and (ap_enable_reg_pp2_iter0 = ap_const_logic_1) and (icmp_ln117_fu_564_p2 = ap_const_lv1_1))) then
    ...
    BFIFO_1_write_assign_proc : process(icmp_ln108_reg_667_pp1_iter1_reg, ap_enable_reg_pp1_iter2, ap_block_pp1_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp1_stage0_11001) and (ap_enable_reg_pp1_iter2 = ap_const_logic_1) and (icmp_ln108_reg_667_pp1_iter1_reg = ap_const_lv1_0))) then 
    ...
    begin
        if (((ap_const_boolean_0 = ap_block_pp1_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1))) then 
            GBUFF_K_V_address0 <= zext_ln108_fu_510_p1(7 - 1 downto 0);
        elsif (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            GBUFF_K_V_address0 <= zext_ln98_reg_636(7 - 1 downto 0);
        else 
    ...
    GBUFF_K_V_we0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_11001, icmp_ln98_reg_632, ap_enable_reg_pp0_iter1)
    begin
        if (((icmp_ln98_reg_632 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    GBUFF_P_V_address0_assign_proc : process(ap_CS_fsm_pp0_stage0, zext_ln98_reg_636, ap_CS_fsm_pp1_stage0, zext_ln108_reg_671, ap_enable_reg_pp1_iter1, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, ap_block_pp1_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp1_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0) and (ap_enable_reg_pp1_iter1 = ap_const_logic_1))) then 
            GBUFF_P_V_address0 <= zext_ln108_reg_671(7 - 1 downto 0);
        elsif (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            GBUFF_P_V_address0 <= zext_ln98_reg_636(7 - 1 downto 0);
        else 
    ...
    GBUFF_P_V_d0 <= ((v1_V_fu_468_p1 & v2_V_2_fu_464_p1) & v2_V_fu_460_p1);

    GBUFF_P_V_we0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_11001, icmp_ln98_reg_632, ap_enable_reg_pp0_iter1)
    begin
        if (((icmp_ln98_reg_632 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    K_arr_address0 <= zext_ln98_fu_452_p1(7 - 1 downto 0);
    ...
    P_arr_x_address0 <= zext_ln98_fu_452_p1(7 - 1 downto 0);
    ...
    P_arr_y_address0 <= zext_ln98_fu_452_p1(7 - 1 downto 0);
    ...
    P_arr_z_address0 <= zext_ln98_fu_452_p1(7 - 1 downto 0);
    ...
    add_ln108_fu_498_p2 <= std_logic_vector(unsigned(i_1_reg_396) + unsigned(ap_const_lv8_1));
    add_ln117_fu_570_p2 <= std_logic_vector(unsigned(i_2_reg_407) + unsigned(ap_const_lv5_1));
    add_ln691_1_fu_587_p2 <= std_logic_vector(unsigned(num_padd_ops_V_reg_418) + unsigned(ap_const_lv13_1FFF));
    add_ln691_fu_544_p2 <= std_logic_vector(unsigned(reuse_select_fu_537_p3) + unsigned(ap_const_lv13_1));
    add_ln98_fu_440_p2 <= std_logic_vector(unsigned(i_reg_385) + unsigned(ap_const_lv8_1));
    addr_cmp_fu_523_p2 <= "1" when (reuse_addr_reg_fu_110 = zext_ln534_fu_515_p1) else "0";
    ...
    ap_block_pp1_stage0_01001_assign_proc : process(BFIFO_1_full_n, icmp_ln108_reg_667_pp1_iter1_reg, ap_enable_reg_pp1_iter2)
    begin
                ap_block_pp1_stage0_01001 <= ((ap_const_logic_0 = BFIFO_1_full_n) and (ap_enable_reg_pp1_iter2 = ap_const_logic_1) and (icmp_ln108_reg_667_pp1_iter1_reg = ap_const_lv1_0));
    end process;


    ap_block_pp1_stage0_11001_assign_proc : process(BFIFO_1_full_n, icmp_ln108_reg_667_pp1_iter1_reg, ap_enable_reg_pp1_iter2)
    begin
                ap_block_pp1_stage0_11001 <= ((ap_const_logic_0 = BFIFO_1_full_n) and (ap_enable_reg_pp1_iter2 = ap_const_logic_1) and (icmp_ln108_reg_667_pp1_iter1_reg = ap_const_lv1_0));
    end process;


    ap_block_pp1_stage0_subdone_assign_proc : process(BFIFO_1_full_n, icmp_ln108_reg_667_pp1_iter1_reg, ap_enable_reg_pp1_iter2)
    begin
                ap_block_pp1_stage0_subdone <= ((ap_const_logic_0 = BFIFO_1_full_n) and (ap_enable_reg_pp1_iter2 = ap_const_logic_1) and (icmp_ln108_reg_667_pp1_iter1_reg = ap_const_lv1_0));
    end process;
    ...
    ap_block_state14_pp1_stage0_iter2_assign_proc : process(BFIFO_1_full_n, icmp_ln108_reg_667_pp1_iter1_reg)
    begin
                ap_block_state14_pp1_stage0_iter2 <= ((ap_const_logic_0 = BFIFO_1_full_n) and (icmp_ln108_reg_667_pp1_iter1_reg = ap_const_lv1_0));
    end process;
    ...
    ap_condition_pp0_exit_iter0_state9_assign_proc : process(icmp_ln98_fu_446_p2)
    begin
        if ((icmp_ln98_fu_446_p2 = ap_const_lv1_1)) then 
    ...
    ap_condition_pp1_exit_iter0_state12_assign_proc : process(icmp_ln108_fu_504_p2)
    begin
        if ((icmp_ln108_fu_504_p2 = ap_const_lv1_1)) then 
    ...
    ap_condition_pp2_exit_iter0_state16_assign_proc : process(icmp_ln117_fu_564_p2)
    begin
        if ((icmp_ln117_fu_564_p2 = ap_const_lv1_1)) then 
    ...
    count_B_V_address1_assign_proc : process(ap_CS_fsm_state1, ap_CS_fsm_pp1_stage0, ap_enable_reg_pp1_iter1, ap_CS_fsm_state8, ap_CS_fsm_state2, ap_CS_fsm_state3, ap_CS_fsm_state4, ap_CS_fsm_state5, ap_CS_fsm_state6, ap_CS_fsm_state7, ap_block_pp1_stage0, zext_ln534_fu_515_p1)
    begin
        if (((ap_const_boolean_0 = ap_block_pp1_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0) and (ap_enable_reg_pp1_iter1 = ap_const_logic_1))) then 
            count_B_V_address1 <= zext_ln534_fu_515_p1(4 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state8)) then 
    ...
    count_B_V_d0_assign_proc : process(ap_CS_fsm_state1, ap_enable_reg_pp1_iter2, ap_CS_fsm_state8, ap_CS_fsm_state2, ap_CS_fsm_state3, ap_CS_fsm_state4, ap_CS_fsm_state5, ap_CS_fsm_state6, ap_CS_fsm_state7, ap_block_pp1_stage0, add_ln691_fu_544_p2)
    begin
    ...
    count_B_V_we0_assign_proc : process(ap_start, ap_CS_fsm_state1, icmp_ln108_reg_667_pp1_iter1_reg, ap_enable_reg_pp1_iter2, ap_block_pp1_stage0_11001, ap_CS_fsm_state8, ap_CS_fsm_state2, ap_CS_fsm_state3, ap_CS_fsm_state4, ap_CS_fsm_state5, ap_CS_fsm_state6, ap_CS_fsm_state7)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state7) or (ap_const_logic_1 = ap_CS_fsm_state6) or (ap_const_logic_1 = ap_CS_fsm_state5) or (ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3) or (ap_const_logic_1 = ap_CS_fsm_state2) or (ap_const_logic_1 = ap_CS_fsm_state8) or ((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1)) or ((ap_const_boolean_0 = ap_block_pp1_stage0_11001) and (ap_enable_reg_pp1_iter2 = ap_const_logic_1) and (icmp_ln108_reg_667_pp1_iter1_reg = ap_const_lv1_0)))) then 
    ...
    icmp_ln98_fu_446_p2 <= "1" when (i_reg_385 = ap_const_lv8_80) else "0";
    num_padd_ops_V_1_fu_593_p2 <= std_logic_vector(unsigned(add_ln691_1_fu_587_p2) + unsigned(count_B_V_q0));
    num_padd_ops_V_2_fu_599_p3 <= 
        num_padd_ops_V_reg_418 when (icmp_ln874_fu_581_p2(0) = '1') else 
        num_padd_ops_V_1_fu_593_p2;
    reuse_select_fu_537_p3 <= 
        reuse_reg_fu_114 when (addr_cmp_reg_692(0) = '1') else 
        count_B_V_q1;
    v1_V_fu_468_p1 <= P_arr_x_q0(13 - 1 downto 0);
    v2_V_2_fu_464_p1 <= P_arr_y_q0(13 - 1 downto 0);
    v2_V_fu_460_p1 <= P_arr_z_q0(13 - 1 downto 0);
    zext_ln108_fu_510_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_1_reg_396),64));
    zext_ln117_fu_576_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_2_reg_407),64));
    zext_ln534_fu_515_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(GBUFF_K_V_q0),64));
    zext_ln98_fu_452_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_reg_385),64));
end behav;
